<div id="footer-wp">
    <div id="foot-body">
        <div class="wp-inner clearfix">
            <div class="block" id="info-company">
                ...
                <div id="payment">
                    <div class="thumb">
                        <img src="client/images/img-foot.png" alt="">
                    </div>
                </div>
            </div>
    ...
    <div id="foot-bot">
        <div class="wp-inner">
            <p id="copyright">© Bản quyền thuộc về tiktok:@duyetne | Php Master</p>
        </div>
    </div>
</div>
</div>
...
<div id="btn-top"><img src="client/images/icon-to-top.png" alt=""/></div>
<div id="fb-root"></div>
